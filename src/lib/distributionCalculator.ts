...
export const distributionConfig: Record<string, Record<string, DistributionConfig>> = {
  "1 color": {
    ...
    "XS-S-M-L": { distribution: "5-4-4-5", total: 18 },
    ...
    "06-08-10-12": { distribution: "5-4-4-5", total: 18 },
  ...
  "2 colores": {
    ...
    "XS-S-M-L": { distribution: "4-6-6-4", total: 20 },
    ...
    "06-08-10-12": { distribution: "4-6-6-4", total: 20 },

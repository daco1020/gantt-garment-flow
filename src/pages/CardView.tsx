    ...
    <main className="max-w-7xl mx-auto px-6 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-2 text-lg">
          Control de inventario y tiempos de maduración.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {paginatedReferences.map(ref => <Card key={ref.id} onClick={() => handleCardClick(ref)} className="group overflow-hidden hover:shadow-2xl hover:shadow-indigo-500/10 transition-all duration-300 border-border/50 bg-card/60 backdrop-blur-sm cursor-pointer hover:-translate-y-1">
